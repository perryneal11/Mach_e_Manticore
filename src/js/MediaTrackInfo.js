    ...
    render() {
        ...
        return (
            <div className="media-track__time">
                <span className="t-small t-medium th-f-accent-color" style={primaryStyle}>{startTime} </span><span className="end-time t-small t-medium th-f-color-alt">{endTime}</span>
            </div>
        )
    }
}
