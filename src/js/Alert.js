    ...
    render() {
        ...
        return (
            <div className="alert">
                ...
                <div>
                <div className="app_tray_drawer_handle_indicator_alert"></div>
                <div className="app_tray_drawer_handle_alert"></div>
                <div className="app_tray_drawer_gradients_alert"></div>
                </div>
            </div>
        )
    }
