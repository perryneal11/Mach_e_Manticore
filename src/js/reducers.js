...
function ui(state = {}, action) {
    ...
    switch (action.type) {
        ...
        case Actions.SCROLLABLE_MESSAGE:
            app.scrollableMessage.showScrollableMessage = true
            app.scrollableMessage.messageText = action.messageText
            app.scrollableMessage.timeout = action.timeout
