...
class RpcFactory {
    ...
    static ScrollableMessageResponse(rpcID) {
        return ({
            "jsonrpc": "2.0",
            "id": rpcID,
            "result": {
    ...
    static ScrollableMessageAbortedResponse(rpcID) {
        return ({
            ...
            "error": {
                "code": 5,
                "message": "The ScrollableMessage Interaction was cancelled",
                "data": {
                    "method": "UI.ScrollableMessage"
                }
            }
    ...
    static SetDisplayLayoutResponse(rpc) {
        ...
        "TEXTBUTTONS_ONLY", "TILES_ONLY", "TEXT_WITH_GRAPHIC", "GRAPHIC_WITH_TEXT", "DOUBLE_GRAPHIC_WITH_SOFTBUTTONS", "TILES_WITH_GRAPHIC"];
