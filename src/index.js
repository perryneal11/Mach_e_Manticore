...
class HMIApp extends React.Component {
    constructor(props) {
        ...
        window.appTrayDrawer = <span><div className="app_tray_drawer_handle_indicator"></div><div className="app_tray_drawer_handle"></div><div className="app_tray_drawer_gradients"></div></span>;
    }
    handleClick() {
    ...
    render() {
        ...
        if (themeClass == 'dark-theme') {
            button = <DarkDots className="dark_dots"/>
        } else {
            button = <LightDots className= "light_dots"/>
        }
        //console.log("DB - index.js window.appTrayDrawer -> " + window.appTrayDrawer);
        //console.log("DB - index.js window.location.hash -> " + window.location.hash);
        window.appTrayDrawer = (!window.appTrayDrawer && window.location.hash === "#/") ? <span><div className="app_tray_drawer_handle_indicator"></div><div className="app_tray_drawer_handle"></div><div className="app_tray_drawer_gradients"></div></span> : null
        return(
            <div>
